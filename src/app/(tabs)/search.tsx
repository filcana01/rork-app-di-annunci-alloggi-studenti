  ...
  const applyFilters = () => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(l => 
        ...
        l.location.address.toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
    ...
    if (filters.city) {
      filtered = filtered.filter(l => 
        l.location.address.toLowerCase().includes(filters.city!.toLowerCase())
      );
    }
    ...
    if (filters.furnishing) {
      filtered = filtered.filter(l => l.furnished === filters.furnishing);
    }
