...
import { ListingCategory, FurnishingStatus, Listing, AvailabilityType, AccessibilityFeature } from '@/types';
...
export default function CreateListingScreen() {
  ...
  const updateAccessibility = (feature: AccessibilityFeature) => {
    setForm(prev => ({
      ...prev,
        ...
        <View style={styles.form}>
            ...
            <View style={styles.section}>
              ...
              {Object.entries({
                ...
                <TouchableOpacity
                  key={key}
                  style={styles.checkboxRow}
                  onPress={() => updateFeatures(key, !form.features[key as keyof typeof form.features])}
                >
                  <View style={[
                    styles.checkbox, 
                    form.features[key as keyof typeof form.features] && styles.checkboxActive
                  ]} />
          ...
          <View style={styles.section}>
            ...
            <View style={styles.availabilityButtons}>
              {(['immediately', 'from_date'] as AvailabilityType[]).map(type => (
                <TouchableOpacity
                  key={type}
                  style={[
          ...
          <View style={styles.section}>
            ...
            {Object.entries({
              ...
              <TouchableOpacity
                key={key}
                style={styles.checkboxRow}
                onPress={() => updateAccessibility(key as AccessibilityFeature)}
              >
                <View style={[
                  styles.checkbox, 
                  form.accessibility.includes(key as AccessibilityFeature) && styles.checkboxActive
                ]} />
                <Text style={styles.checkboxText}>{label}</Text>
              </TouchableOpacity>
            ))}
